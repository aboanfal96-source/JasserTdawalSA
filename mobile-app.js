...
const NAMES = {
'2222':'أرامكو','1120':'الراجحي','7010':'STC','2010':'سابك','1180':'الأهلي','2280':'المراعي',
'1150':'الإنماء','4190':'جرير','4013':'الحبيب','2082':'أكوا باور','4001':'العثيم','4161':'بن داود',
'4164':'النهدي','7020':'موبايلي','1010':'الرياض','4300':'دار الأركان','4250':'جبل عمر','2350':'كيان',
'5110':'الكهرباء','1211':'معادن','1060':'ساب','4002':'المواساة','2290':'ينساب','2310':'سبكيم',
'2380':'بترو رابغ','3030':'أسمنت السعودية','4220':'إعمار','8010':'التعاونية','8210':'بوبا',
'7030':'زين','2050':'صافولا','4280':'المملكة','2381':'الحفر','1140':'البلاد','4003':'إكسترا',
'2020':'سافكو','4040':'سيسكو','2330':'المتقدمة','6013':'التموين','1080':'العربي الوطني'
}
const SECS = {};
...
const BPX = {'2222':28,'1120':95,'7010':42,'2010':75,'1180':32,'2280':58,'1150':28,'4190':120,'4013':190,'2082':290,'1010':30,'1020':18,'1030':15,'1050':38,'1060':36,'1080':25,'1140':40,'2020':100,'2050':35,'2060':14,'2170':45,'2210':42,'2290':55,'2310':30,'2330':65,'2350':12,'2380':15,'2381':80,'3010':25,'3020':30,'3030':55,'3040':60,'3050':65,'3060':35,'3080':32,'4001':95,'4002':180,'4003':80,'4004':45,'4005':25,'4006':40,'4007':50,'4161':100,'4162':70,'4163':75,'4164':130,'4190':120,'4192':25,'4300':8,'4250':20,'4280':8,'5110':16,'5120':40,'6013':80,'7020':50,'7030':8,'7200':350,'1211':50,'1212':55,'8010':95,'8210':180};
